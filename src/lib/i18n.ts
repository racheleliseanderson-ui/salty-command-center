...
const DICT = {
  en: {
    ...
    "search.placeholder": "Search tools, handoffs, limits, terms…",
    ...
    "footer.suite": "Suite",
    "footer.constraints": "Standing constraints",
  },
  es: {
    "nav.desk": "Mesa",
    ...
    "search.placeholder": "Busca herramientas, traspasos, límites, términos…",
